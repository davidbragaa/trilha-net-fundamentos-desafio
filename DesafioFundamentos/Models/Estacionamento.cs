namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        {
            // Implantado: Pedir para o usuário digitar uma placa (ReadLine) e adicionar na lista "veiculos"
            // *IMPLEMENTE AQUI*
            Console.WriteLine("Digite a placa do veículo que ira estacionar:");
        ...
        public void ListarVeiculos()
        {
            ...
            if (veiculos.Any())
            {
                ...
                foreach (string item in veiculos)
                 {
                    Console.WriteLine($"Quantidade de Veiculos esta estacionados {contadorVeiculo} - {item}");
                    contadorVeiculo++;
